...
experiment 'RUN THEM ALL !!' type: batch repeat: 4 keep_seed: true until: (nb_E_students = 0 and  nb_I_students = 0 and current_date.minute_of_day = 470){
	
	reflex end_of_each_simulation{
		...
		ask simulations{
			ask students {
				...
				save[id, name, type, t1_even, t2_even, t3_even, t4_even, t1_odd, t2_odd, t3_odd, t4_odd, is_susceptible, is_exposed, 
					...
					infected_by, infective_day, infective_minute, is_using_facemask] to: "../results/Agents_after_simulation_" + simulation_repetition + ".csv" type:"csv" rewrite: false;
				
				save[id, type, infected_by,  infected_x, infected_y, exposed_day, exposed_minute] to: "../results/Transmission_list_" + simulation_repetition + ".csv" type:"csv" rewrite: false;
			...
			ask statics {
				save[id, type, infected_by,  infected_x, infected_y, infective_day, infective_minute] to: "../results/Transmission_list_" + simulation_repetition + ".csv" type:"csv" rewrite: false;
			}
			
			// TXT file with the intial parameters used in the model.
			save ("***#####################################################################################################***" +
				...
				"\n\n***#####################################################################################################***\n\n") 
				to: "../results/Initial_data_and_parameters_" + simulation_repetition +  ".txt" rewrite: false;
					
			
			//Write a message alerting the user that the simulation has been finished.
			write 'Simulation ' + simulation_repetition + ' has finished!!' color: #red;
			
			simulation_repetition <- simulation_repetition + 1;
		}
	}
}
